...
export default function AccountBadge() {
  ...
  // One button. It connects the wallet if none is (auto-picking extension vs
  // WalletConnect QR/deep-link by device), then signs — no browser-vs-mobile
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      ...
      >
        {busy ? <span className="spin">…</span> : walletConnected ? "sign in" : "connect wallet"}
      </button>
